    ...
    while available_words:
        ...
        while tries != 0:
            ...
            try:
                ...
                print("\n")
                print(("Invalid input [Press ENTER]").center(160))
                print("\n")
                print(" "*79,end="")
                breaker = input((""))
                continue
            ...
            if letter in words[randomise]["word"]:
                ...
                for j in range(len(words[randomise]["word"])):
                    ...
                    if "_" not in words[randomise]["spaces"]:
                        os.system("cls")
                        print("\n\n")
                        if (len(words[randomise]["word"]) <= 9):
                            line_length = 24
                        else:
                            line_length = len(words[randomise]["word"]) * 2 + 4
...
if __name__ == "__main__":
    ...
    game.play()
>>>>>>> 60f2856778123768aef3e82baf1785fd4c2600d5
